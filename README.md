...
🔗 Live Demo: https://rag-model-exd644htsyhkztvexswdgx.streamlit.app/ 📦 Repository: https://github.com/Naveen-S-RK/RAG-MODEL
...
Create a Pinecone index Create an index in your Pinecone console whose dimension matches the embedding model's output size (all-MiniLM-L6-v2 produces 384-dimensional vectors).
...
Add your HR policy document Place your PDF at ./resources/HR_and_Digital_Workspace_Policy.pdf (or update pdf_path in dataprocessor.py).
Usage
